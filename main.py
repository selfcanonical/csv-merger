...
def main():
    ...
    st.markdown("""
    Welcome to Yet Another CSV Merger by [Self Canonical](https://selfcanonical.com/). This tool merges multiple CSV files into a single Excel file, with each CSV becoming a separate sheet. Handy for merging SEO audit reports generated by Ahrefs, Screaming Frog etc into one file.    
