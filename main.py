...
def main():
    st.title("Yet Another CSV Merger")
    
    st.write("""
    ### About
    Welceom to Yet Another CSV Merger by <a href="https://selfcanonical.com/">Self Canonical</a>. This tool merges multiple CSV files into a single Excel file, with each CSV becoming a separate sheet. Handy for merging SEO audit reports generated by Ahrefs, Screaming Frog etc into one file.
